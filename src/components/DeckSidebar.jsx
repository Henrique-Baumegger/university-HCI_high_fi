...
const DeckSidebar = ({ deck, allDecks, onClose, onUpdateCard, onAddCard, onDeleteCard, onAddLink }) => {
    ...
    return (
        <div className="fixed right-0 top-0 bottom-0 w-80 bg-white dark:bg-gray-800 border-l border-black dark:border-gray-600 shadow-xl z-40 flex flex-col transform transition-transform duration-300 ease-in-out">
            {/* Header */}
